...
class generarInventario():
    """Clase que genera un PDF con la lista de productos de la tienda de mascotas.
                Metodos:
                     __init__ --Constructor
        """
    def __init__(self):
        """Constructor de la clase que genera un informe de los productos de la tienda.
        ...
        listaInventario.append(list(['','','TIENDA DE MASCOTAS','','','']))
